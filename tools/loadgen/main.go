...
func main() {
	...
	if len(os.Args) < 2 {
		fmt.Fprintln(os.Stderr, "usage: loadgen <seed|pool-export|run|teardown|soak|members-sustained|members-capacity|history-sustained|max-rps|daily|verify|max-room-size|presence-sustained|presence-storm|presence-capacity> [flags]")
		os.Exit(2)
	}
