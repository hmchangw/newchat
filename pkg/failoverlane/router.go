...
// BuildRouter builds one lane's router: it constructs that lane's NATS-bound
...
// connection.
type BuildRouter func(ctx context.Context, conn *o11ynats.Conn, js o11ynats.JetStream, lane subject.Lane) (*natsrouter.Router, error)
...
func BindRouters(ctx context.Context, home *o11ynats.Conn, homeJS o11ynats.JetStream,
	buddy *natsutil.BuddyDialer, build BuildRouter,
) (*Routers, error) {
