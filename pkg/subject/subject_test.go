...
func TestSubjectBuilders(t *testing.T) {
	tests := []struct {
		...
		{"SearchOrgs", subject.SearchOrgs("alice", "site-a"),
			"chat.user.alice.request.search.site-a.orgs"},
		{"SearchOrgsPattern", subject.SearchOrgsPattern("site-a"),
			"chat.user.{account}.request.search.site-a.orgs"},
