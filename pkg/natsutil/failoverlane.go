...
// FailoverBinder readies and binds a standby lane on a buddy cluster.
//
...
type FailoverBinder struct {
	// Service and SiteID label the lane's metrics.
	Service string
	SiteID  string
...
func (b *FailoverBinder) MetricsIdentity(spec *LaneSpec) natsmetrics.ConsumerConfig {
...
func (b *FailoverBinder) BindConsumer(ctx context.Context, bjs o11ynats.JetStream, spec *LaneSpec) (o11ynats.Consumer, error) {
...
func (b *FailoverBinder) Bind(ctx context.Context, bjs o11ynats.JetStream, spec *LaneSpec,
	...
	if b.Metrics == nil {
		RunPool(iter, b.Sem, b.WG, handle)
		return NewLane(iter, b.WG), nil
	}
