...
// closed but wide — destination x operation x outcome is 924 combinations,
...
func TestRecorderConstructionDoesNotPrecomputeTheCrossProduct(t *testing.T) {
	...
	assert.Less(t, publisher, float64(100), "Publisher construction must not precompute 924 unused attribute sets")
