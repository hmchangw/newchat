...
import (
	...
	orgdisplay "github.com/hmchangw/chat/pkg/orgdisplay"
...
func (m *MockSubscriptionStore) FetchOrgDisplayUsers(ctx context.Context, orgIDs []string) ([]orgdisplay.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FetchOrgDisplayUsers", ctx, orgIDs)
	ret0, _ := ret[0].([]orgdisplay.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// FetchOrgDisplayUsers indicates an expected call of FetchOrgDisplayUsers.
func (mr *MockSubscriptionStoreMockRecorder) FetchOrgDisplayUsers(ctx, orgIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FetchOrgDisplayUsers", reflect.TypeOf((*MockSubscriptionStore)(nil).FetchOrgDisplayUsers), ctx, orgIDs)
}
...
// ListOrgRoomMembers mocks base method.
func (m *MockSubscriptionStore) ListOrgRoomMembers(ctx context.Context, roomID string, orgIDs []string) ([]model.RoomMember, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListOrgRoomMembers", ctx, roomID, orgIDs)
	ret0, _ := ret[0].([]model.RoomMember)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListOrgRoomMembers indicates an expected call of ListOrgRoomMembers.
func (mr *MockSubscriptionStoreMockRecorder) ListOrgRoomMembers(ctx, roomID, orgIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListOrgRoomMembers", reflect.TypeOf((*MockSubscriptionStore)(nil).ListOrgRoomMembers), ctx, roomID, orgIDs)
}
