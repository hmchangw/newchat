...
| — | `internal` | Teams meetings not configured (Azure app credentials absent), the organizer could not be resolved to an Azure object ID, or the Graph create failed. |
