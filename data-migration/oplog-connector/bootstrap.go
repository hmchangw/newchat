...
// bootstrapStreams owns the connector's target stream — MIGRATION_OPLOG_{siteID} in migration mode,
// DR_OPLOG_{siteID} in DR mode. Enabled it creates from schema (Name+Subjects); disabled it verifies
