...
// fetchTestBefore is the walk ceiling passed by fetcher tests that don't
// assert on it.
...
// #7 + #6: the request carries the caller's walk ceiling, and the reply's
// pointer rides back alongside the preview.
