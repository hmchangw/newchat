...
// fakeSessionStore is a hand-rolled session.Store test double — function-valued
// fields let each test set only the behavior it needs, and calling an unset
// field panics loudly rather than silently returning a zero value.
