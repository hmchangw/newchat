...
func (m *MockAdminStore) ListRooms(ctx context.Context, q string, page, limit int) ([]model.Room, int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListRooms", ctx, q, page, limit)
...
func (mr *MockAdminStoreMockRecorder) ListRooms(ctx, q, page, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListRooms", reflect.TypeOf((*MockAdminStore)(nil).ListRooms), ctx, q, page, limit)
}
