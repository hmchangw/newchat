...
// countAndSetParentTcount recomputes tcount+tlm from the surviving rows, sets both,
// and returns them. Returns (nil, nil, nil) when ThreadParentCreatedAt is unset;
// tlm nil when no replies survive.
