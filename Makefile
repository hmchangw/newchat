...
coverage-loadgen-soak:
	...
	go run ./tools/coveragecheck -profile $(SOAK_COVERAGE_PROFILE) -include tools/loadgen/soak_ -include tools/loadgen/internal/soak/catalog/ -include tools/loadgen/internal/soak/collector/ -include tools/loadgen/internal/soak/mutation/ -include tools/loadgen/internal/soak/presence/ -include tools/loadgen/internal/soak/read/ -include tools/loadgen/internal/soak/search/ -include tools/loadgen/internal/soak/send/ -include tools/loadgen/internal/soak/userread/ -include tools/loadgen/internal/soak/workload/ -exclude soak_main.go -exclude soak_store.go -min 90
