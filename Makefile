...
coverage-loadgen-soak:
	...
	go run ./tools/coveragecheck -profile $(SOAK_COVERAGE_PROFILE) -include tools/loadgen/soak_ -include tools/loadgen/internal/soak/catalog/ -include tools/loadgen/internal/soak/send/ -include tools/loadgen/internal/soak/userread/ -exclude soak_main.go -exclude soak_store.go -min 90
