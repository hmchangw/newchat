...
// Source: github.com/hmchangw/chat/user-service/service (interfaces: SubscriptionRepository,UserRepository,AppRepository,RoomClient,HistoryClient,PresenceClient,EventPublisher,ThreadSubscriptionRepository,SettingsRepository)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_repository.go -package=mocks . SubscriptionRepository,UserRepository,AppRepository,RoomClient,HistoryClient,PresenceClient,EventPublisher,ThreadSubscriptionRepository,SettingsRepository
//
...
func (m *MockSettingsRepository) GetUserSettings(ctx context.Context, account, siteID string) (*model.UserSettings, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserSettings", ctx, account, siteID)
...
func (mr *MockSettingsRepositoryMockRecorder) GetUserSettings(ctx, account, siteID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserSettings", reflect.TypeOf((*MockSettingsRepository)(nil).GetUserSettings), ctx, account, siteID)
}

// SetUserSettings mocks base method.
func (m *MockSettingsRepository) SetUserSettings(ctx context.Context, account, siteID string, data json.RawMessage, ifVersion *int64) (*model.UserSettings, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetUserSettings", ctx, account, siteID, data, ifVersion)
	ret0, _ := ret[0].(*model.UserSettings)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSettingsRepositoryMockRecorder) SetUserSettings(ctx, account, siteID, data, ifVersion any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetUserSettings", reflect.TypeOf((*MockSettingsRepository)(nil).SetUserSettings), ctx, account, siteID, data, ifVersion)
}
