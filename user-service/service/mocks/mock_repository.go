...
// Source: github.com/hmchangw/chat/user-service/service (interfaces: SubscriptionRepository,UserRepository,AppRepository,RoomClient,HistoryClient,PresenceClient,EventPublisher,ThreadSubscriptionRepository,SSOTokenRepository,TokenValidator,TokenRefresher,PermissionRepository)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_repository.go -package=mocks . SubscriptionRepository,UserRepository,AppRepository,RoomClient,HistoryClient,PresenceClient,EventPublisher,ThreadSubscriptionRepository,SSOTokenRepository,TokenValidator,TokenRefresher,PermissionRepository
//
...
import (
	...
	oidc "github.com/hmchangw/chat/pkg/oidc"
...
// MockSSOTokenRepository is a mock of SSOTokenRepository interface.
type MockSSOTokenRepository struct {
	ctrl     *gomock.Controller
	recorder *MockSSOTokenRepositoryMockRecorder
	isgomock struct{}
}

// MockSSOTokenRepositoryMockRecorder is the mock recorder for MockSSOTokenRepository.
type MockSSOTokenRepositoryMockRecorder struct {
	mock *MockSSOTokenRepository
}

// NewMockSSOTokenRepository creates a new mock instance.
func NewMockSSOTokenRepository(ctrl *gomock.Controller) *MockSSOTokenRepository {
	mock := &MockSSOTokenRepository{ctrl: ctrl}
	mock.recorder = &MockSSOTokenRepositoryMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSSOTokenRepository) EXPECT() *MockSSOTokenRepositoryMockRecorder {
	return m.recorder
}

// GetByUsername mocks base method.
func (m *MockSSOTokenRepository) GetByUsername(ctx context.Context, username string) (*model.SSOToken, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByUsername", ctx, username)
	ret0, _ := ret[0].(*model.SSOToken)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetByUsername indicates an expected call of GetByUsername.
func (mr *MockSSOTokenRepositoryMockRecorder) GetByUsername(ctx, username any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByUsername", reflect.TypeOf((*MockSSOTokenRepository)(nil).GetByUsername), ctx, username)
}

// Upsert mocks base method.
func (m *MockSSOTokenRepository) Upsert(ctx context.Context, username, ssoToken string, ssoTokenExpMs int64, refreshToken string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Upsert", ctx, username, ssoToken, ssoTokenExpMs, refreshToken)
	ret0, _ := ret[0].(error)
	return ret0
}

// Upsert indicates an expected call of Upsert.
func (mr *MockSSOTokenRepositoryMockRecorder) Upsert(ctx, username, ssoToken, ssoTokenExpMs, refreshToken any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Upsert", reflect.TypeOf((*MockSSOTokenRepository)(nil).Upsert), ctx, username, ssoToken, ssoTokenExpMs, refreshToken)
}
...
func (m *MockTokenValidator) Validate(ctx context.Context, raw string) (oidc.Claims, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Validate", ctx, raw)
...
func (mr *MockTokenValidatorMockRecorder) Validate(ctx, raw any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Validate", reflect.TypeOf((*MockTokenValidator)(nil).Validate), ctx, raw)
}
...
func (m *MockTokenRefresher) Refresh(ctx context.Context, refreshToken string) (oidc.TokenSet, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTokenRefresherMockRecorder) Refresh(ctx, refreshToken any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetLatestGrant mocks base method.
func (m *MockPermissionRepository) GetLatestGrant(ctx context.Context, siteID string, permission model.PermissionKey, subjectAccount string) (*model.PermissionGrant, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLatestGrant", ctx, siteID, permission, subjectAccount)
	ret0, _ := ret[0].(*model.PermissionGrant)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetLatestGrant indicates an expected call of GetLatestGrant.
func (mr *MockPermissionRepositoryMockRecorder) GetLatestGrant(ctx, siteID, permission, subjectAccount any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLatestGrant", reflect.TypeOf((*MockPermissionRepository)(nil).GetLatestGrant), ctx, siteID, permission, subjectAccount)
}
